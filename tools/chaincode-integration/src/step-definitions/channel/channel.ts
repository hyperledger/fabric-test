...
export class Channel {
    ...
    public async channel(channelName: string, profile: string) {
      
    }

    @given(/Infrastructure provider is ['"](.*)['"]$/, '', TIMEOUT)
    public async infrastructureProvider(provider: string) {
        this.workspace.setInfrastuctureProvider(provider, this);
    }

    @given(/Clean Infrastructure for network ['"](.*)['"]$/, '', TIMEOUT)
    public async clean(profileName: string) {
    ...
    public async setup(profileName: string, channelName: string) {
    ...
    public async deployCC(channelName: string, chaincodeName: string) {
    ...
    public async startCCAAS(chaincodeName: string) {
    ...
    public async deployCCAAS(channelName: string, chaincodeName: string) {
