...
#### execute testcase FAB-4038-2i: 2 invokes, golevelDB
./test_driver.sh -t FAB-4038-2i
#### gather TPS from docker containers
./get_peerStats.sh -r FAB-4038-2i -p peer0.org1.example.com peer0.org2.example.com -n $PREFIX -o $CWD -v

#### execute testcase FAB-4036-2q: 2 queries, golevelDB
