...
CCPathmarbles02="github.com/hyperledger/fabric-test/chaincodes/marbles02/go"
CCPathmarbles02="${CCPathmarbles02//\//\\/}"
MatadataPath="github.com/hyperledger/fabric-test/chaincodes/marbles02/go/META-INF"
