...
// This chaincode is a test for chaincode invoking another chaincode - invokes example02
...
// Invoke invokes another chaincode - example02, upon receipt of an event and changes event state
