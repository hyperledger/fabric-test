...
Scenario Outline: FAB-3865: Multiple Channels Per Peer, with <type> orderer
    ...
    And a user deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "cc1" on channel "chn1"
...
Scenario Outline: FAB-3866: Multiple Chaincodes Per Peer, with <type> orderer
    ...
    When a user deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "example02"
...
Scenario: FAB-8759: Test querying a peer with two different versions of chaincode - values change
  ...
  And a user deploys chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "vt" on channel "versioningtest"
  ...
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" as version "3" with args ["init","a","1000","b","2000"] with name "vt" on all peers
  And I wait "5" seconds
...
Scenario: FAB-7407: Update the channel policies - add an organization
  ...
  When a user installs chaincode at path "github.com/hyperledger/fabric/examples/chaincode/go/example02/cmd" as version "2" with args ["init","a","1000","b","2000"] on all peers
  And I wait "5" seconds
