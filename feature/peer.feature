...
Scenario Outline: FAB-3865: Multiple Channels Per Peer, with <type> orderer
    ...
    And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/example02/go/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "cc1" on channel "chn1"
    When an admin sets up a channel named "chn2"
    And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/mapkeys/go" with args ["init"] with name "cc2" on channel "chn2"
...
Scenario Outline: FAB-3866: Multiple Chaincodes Per Peer, with <type> orderer
    Given I have a bootstrapped fabric network of type <type>
    When an admin sets up a channel
    And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/eventsender" with args [] with name "eventsender"
    ...
    When an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/example02/go/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "example02"
    ...
    Then a user receives a success response of 990
    When an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/mapkeys/go" with args ["init"] with name "map"
    ...
    # the "map" chaincode adds quotes around the result
    Then a user receives a success response of "1000"
    When an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/marbles02_private" with args [] with name "marbles"
    ...
    When an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/sleeper" with args ["1"] with name "sleeper"
...
Scenario: FAB-3855: Empty Payload Messages
    ...
    And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/mapkeys/go" with args ["init"] with name "empty" on channel "emptiness"
...
Scenario: FAB-8759: Test querying a peer with two different versions of chaincode - values change
  ...
  And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/example02/go/cmd" with args ["init", "a", "1000" , "b", "2000"] with name "vt" on channel "versioningtest"
  ...
  When an admin installs chaincode at path "github.com/hyperledger/fabric-test/chaincodes/example02/go/cmd" as version "3" with args ["init","a","1000","b","2000"] with name "vt" on all peers
  And I wait "5" seconds
...
Scenario: FAB-8759: Test querying a peer that has two different versions of chaincode - no change in data
  Given I have a bootstrapped fabric network of type kafka with tls
  When an admin sets up a channel named "versioningtest"
  And an admin deploys chaincode at path "github.com/hyperledger/fabric-test/chaincodes/mapkeys/go" with args ["init"] with name "vt" on channel "versioningtest"
  ...
  When an admin installs chaincode at path "github.com/hyperledger/fabric-test/chaincodes/mapkeys/go" as version "4" with args ["init"] with name "vt" on all peers
  And I wait "5" seconds
...
Scenario: FAB-7407: Update the channel policies - add an organization
  ...
  When an admin installs chaincode at path "github.com/hyperledger/fabric-test/chaincodes/example02/go/cmd" as version "2" with args ["init","a","1000","b","2000"] on all peers
  And I wait "5" seconds
