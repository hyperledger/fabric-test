...
const NETWORKSPECPATH = "../../testdata/publish-network-spec.yml"

func TestSmoke(t *testing.T) {
	RegisterFailHandler(Fail)
	junitReporter := reporters.NewJUnitReporter("results_publish-test-suite.xml")
	RunSpecsWithDefaultAndCustomReporters(t, "Publish Test Suite", []Reporter{junitReporter})
}
