...
func TestChaos(t *testing.T) {
	...
	junitReporter := reporters.NewJUnitReporter("results_chaos-test-suite.xml")
	RunSpecsWithDefaultAndCustomReporters(t, "Chaos Test Suite", []Reporter{junitReporter})
}
...
var _ = BeforeSuite(func() {
	...
	networkSpecPath = path.Join(testDataDir, "chaos-network-spec.yml")
