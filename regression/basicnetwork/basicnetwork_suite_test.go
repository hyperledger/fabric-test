...
func TestBasicnetwork(t *testing.T) {
	...
	junitReporter := reporters.NewJUnitReporter("results_basic-test-suite.xml")
	RunSpecsWithDefaultAndCustomReporters(t, "Basic Test Suite", []Reporter{junitReporter})
}

// Bringing up network using BeforeSuite
var _ = BeforeSuite(func() {
	networkSpecPath := "../../tools/operator/testdata/basic-network-spec.yml"
